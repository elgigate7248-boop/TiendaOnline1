...
router.put('/:id', verificarToken, requiereRol(['ADMIN', 'SUPER_ADMIN', 'REPARTIDOR']), pedidoCtrl.actualizarPedido);
router.delete('/:id', verificarToken, requiereRol(['ADMIN', 'SUPER_ADMIN']), pedidoCtrl.eliminarPedido);
router.get('/:id', verificarToken, requiereRol(['CLIENTE', 'ADMIN', 'SUPER_ADMIN', 'REPARTIDOR']), pedidoCtrl.obtenerPedidoPorId);
